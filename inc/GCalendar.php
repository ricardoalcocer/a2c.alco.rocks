<?php
     ...
     * 
     * I left the original header for clarity and fairness
     * This, however is a stripped down version of the original
     * Not trying to take credit of someone else's work
    */
    class GCalendar{
        ...
        protected  $bAllday         = false;
        protected  $aGuest          = [];
        protected  $strTransparency = '';
        protected  $logger;
